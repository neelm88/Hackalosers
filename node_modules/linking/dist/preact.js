...
function sideEffect$1(Component) {
  let createClass;
  createClass = classFactory(Component);
  return handleChange => {
...
function setup({
  ...
  return {
    link,
    sideEffect: sideEffectFactory(Component),
    startApp: function ({
      reducers,
      preload,
      component,
      ...
      store = createStore(composeReduce(reducers), state, env != null ? typeof env.__REDUX_DEVTOOLS_EXTENSION__ == "function" ? env.__REDUX_DEVTOOLS_EXTENSION__() : void 8 : void 8);
...
({
  ...
  render,
  linkFactory: link$1,
  sideEffectFactory: sideEffect$1
}));

exports.startApp = exports.linkStart;
